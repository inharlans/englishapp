...
import { WordbookStudyClient } from "../study/studyClient";
    ...
    return (
      <section className="space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {localDebugEnabled ? (
            <Link href={{ pathname: "/api/auth/local-debug-login", query: { next: `/wordbooks/${id}/memorize` } }} className="text-sm font-semibold text-blue-700 hover:underline">
              로컬 디버그 로그인
            </Link>
          ) : null}
        </div>
