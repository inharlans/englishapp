  ...
  if (!user) {
    return (
      <section className="space-y-3">
        <h1 className="text-2xl font-black text-slate-900">Blocked Creators</h1>
  ...
  return (
    <section className="space-y-5">
      <header className="space-y-2">
        <h1 className="text-3xl font-black tracking-tight text-slate-900">Blocked Creators</h1>
          ...
          {blocks.map((b) => (
            <div key={b.ownerId} className="rounded-2xl border border-slate-200 bg-white p-4">
              ...
              <p className="mt-1 text-xs text-slate-500">
                blocked {b.createdAt.toISOString().slice(0, 10)}
              </p>
              <div className="mt-3">
